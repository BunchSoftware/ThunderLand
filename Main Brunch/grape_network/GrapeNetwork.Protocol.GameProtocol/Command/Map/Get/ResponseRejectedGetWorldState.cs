...
{
    public class ResponseRejectedGetWorldState : ApplicationCommand
    {
        public ResponseRejectedGetWorldState(ushort GroupCommand, uint Command, string nameService) : base(GroupCommand, Command, nameService)
        {
        }
